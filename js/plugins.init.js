...
try {    
    ...
    function setTheme(theme) {
        ...
        switch (theme) {
            case "style-dark":
                bootstarpHref =  `https://ezfn.dev/assets/css/bootstrap-dark.min.css`
                styleHref = "https://ezfn.dev/assets/css/style-dark.min.css"
                break;
                case "style-rtl":
                bootstarpHref =  `https://ezfn.dev/assets/css/bootstrap-rtl.min.css`
                styleHref = "https://ezfn.dev/assets/css/style-rtl.min.css"
                break;
                case "style-dark-rtl":
                bootstarpHref =  `https://ezfn.dev/assets/css/bootstrap-dark-rtl.min.css`
                styleHref = "https://ezfn.dev/assets/css/style-dark-rtl.min.css"
                break;               
        
            default:
                bootstarpHref =  `https://ezfn.dev/assets/css/bootstrap.min.css`
                styleHref = "https://ezfn.dev/assets/css/style.min.css"
                break;
        }
